...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        modo.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    Toast.makeText(getApplicationContext(),"Noche", Toast.LENGTH_LONG).show();
                    textView.setTextColor(Color.WHITE);
                    editText.setTextColor(Color.WHITE);
                    modo.setTextColor(Color.WHITE);
                    constraintLayout.setBackgroundColor(Color.BLACK);
                }else{
                    Toast.makeText(getApplicationContext(),"Día",Toast.LENGTH_LONG).show();
    ...
    public void siguiente(View view){
       // int random= (int)(Math.random() * mensajes.length);
        ...
        textView.setText(mensajes[numero]);
    }
    ...
    public void buscar(android.view.View view){
        ...
        if(seleccion < min){
            Toast.makeText(this, "Valor demasiado pequeño", Toast.LENGTH_LONG).show();
        }else{
            if(seleccion >max){
                Toast.makeText(this, "DEMASIADO GRANDE", Toast.LENGTH_LONG).show();
            }
        }
